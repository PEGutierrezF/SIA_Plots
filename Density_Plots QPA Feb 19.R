...
L_x <- QPA_X_Feb19 %>% filter(QPA_X_Feb19$source == "Leaflitter")
B_x <- QPA_X_Feb19 %>% filter(QPA_X_Feb19$source == "Biofilm")
A_x <- QPA_X_Feb19 %>% filter(QPA_X_Feb19$source == "Algae")
...
L_a <- QPA_A_Feb19 %>% filter(QPA_A_Feb19$source == "Leaflitter")
B_a <- QPA_A_Feb19 %>% filter(QPA_A_Feb19$source == "Biofilm")
A_a <- QPA_A_Feb19 %>% filter(QPA_A_Feb19$source == "Algae")
...
dens <- lapply(split(QPA_Lm_Feb19, QPA_Lm_Feb19$source), 
               function(x) density(x$density, from = 0, to = 1))
